...
# List directions
mex_dir_path <- "~/Bureau/sc_ATAC_analysis/data/"
...
conv_error_df <- read_csv("~/Bureau/sc_ATAC_analysis/data/hg38_hg19_conv_error.csv",col_names = F)
...
sc_reads_info = read.csv(file = "~/Bureau/sc_ATAC_analysis/data/singlecell.csv")
